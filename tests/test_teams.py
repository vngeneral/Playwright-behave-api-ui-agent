...
class TestValidateTeamsHmac(unittest.TestCase):
    ...
    def test_valid_signature_returns_true(self):
        from agent.integrations.teams import validate_teams_hmac
...
class TestTeamsClientConfigured(unittest.TestCase):
    ...
    @patch("agent.integrations.teams.requests.post")
    ...
    def test_validate_incoming_valid_hmac(self):
        from agent.integrations.teams import TeamsClient, validate_teams_hmac
